...
<body>
    ...
    <form action="proses-edit.php" method="POST">
        ...
        <fieldset>
            ...
            <p>
                <label for="jenis_klamin">Jenis Kelamin :</label>
                <label><input type="radio" name="jenis_klamin" value="laki-laki" value="<?php echo $mapel['jenis_klamin']
                ?>" />Laki-Laki</label>
                <label><input type="radio" name="jenis_klamin" value="perempuan" value="<?php echo $mapel['jenis_klamin']
                ?>" />Perempuan</label>
            </p>
            <p>
